/**
 * [INPUT]: 扫描 public/brain-bytes/<slug>/index.html 的自包含 HTML 文章
 * [OUTPUT]: 生成 public/brain-bytes/index.json（标题/论文/作者/机构/来源），并向每篇注入「返回 Brain & Bytes」导航条
